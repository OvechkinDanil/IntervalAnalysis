...
def init():
    line1 = IntervalVector.create(np.array([Interval(4, 5), Interval(2, 3)]))
    line2 = IntervalVector.create(np.array([Interval(-1, 1), Interval(1, 2)]))

    b = IntervalVector.create(np.array([Interval(10, 22), Interval(1, 10)]))
