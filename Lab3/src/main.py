...
def init():
    line1 = IntervalVector.create(np.array([Interval(0.5, 1.5), Interval(1.5, 3.5)]))
    ...
    b = IntervalVector.create(np.array([Interval(3, 7), Interval(0, 0), Interval(-1, 1)]))
